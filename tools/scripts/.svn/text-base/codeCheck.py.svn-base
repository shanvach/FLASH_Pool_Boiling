...
"""
   ...
   Flame = "source/physics/Flame"
   FlameMain = "source/physics/Flame/FlameMain"
   FlameEff = "source/physics/Flame/FlameEffects"
   FlameSpd = "source/physics/Flame/FlameSpeed"
   ...
   excludes = [pmTwo, pmFour0Kernel, pmFourDev, pmInterp,
       ...
       DiffUG, DiffCG,
       ImBound,
       IncompNS, MultigridFFT, MultigridExperimental, BarnesHutTree ,
       PartPredCorOld,
       EosNuc,
       SimAdvect, SimAdvectMass, SimBubLab, SimCellpb,
       SimCollShock, SimFlame1, SimFlame3, SimFlameBub,
       SimDustCart,
