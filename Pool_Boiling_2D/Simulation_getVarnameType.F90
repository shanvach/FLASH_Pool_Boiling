...
#include "Flash.h"
   ...
   integer, dimension(1:48), parameter :: varnames = (/&
   & CON_ANGLE_VAR, DIVU_VAR, DUPO_VAR, PTES_VAR, RTES_VAR, &
     XI_VAR, XIPO_VAR, AAJUNK_VAR, ALPH_VAR, CURV_VAR, &
     ...
     PREO_VAR, PRES_VAR, RHSO_VAR, RHST_VAR, ROLD_VAR, &
     SIGP_VAR, SMHV_VAR, SMRH_VAR, TEMP_VAR, TMIC_VAR, &
     TNLQ_VAR, TNVP_VAR, TOLD_VAR, TVIS_VAR, VELX_VAR, &
     VELY_VAR, VELZ_VAR, VISC_VAR &
   &/)

   integer, dimension(1:48), parameter :: vartypes = (/&
   & VARTYPE_GENERIC, VARTYPE_GENERIC, VARTYPE_GENERIC, VARTYPE_GENERIC, VARTYPE_GENERIC,&
     ...
     VARTYPE_GENERIC, VARTYPE_GENERIC, VARTYPE_GENERIC, VARTYPE_GENERIC, VARTYPE_GENERIC,&
     VARTYPE_GENERIC, VARTYPE_GENERIC, VARTYPE_GENERIC, VARTYPE_GENERIC, VARTYPE_GENERIC,&
     VARTYPE_GENERIC, VARTYPE_GENERIC, VARTYPE_GENERIC &
   &/)
