...
void FTOC(setup_buildstats)(char* build_date, 
     ...
     strncpy(build_date, "Mon Apr 18 19:02:59 PDT 2022",80);
     strncpy(build_dir, "/home3/svachhan/FLASH/Bubble_RisingVap", 80);
     strncpy(build_machine, "Linux pfe22 3.10.0-1160.59.1.1chaos.ch6.x86_64 #1 SMP Wed Feb 23 10:11:21 PST 20", 80);
     strncpy(setup_call, "/home3/svachhan/FLASH/bin/setup.py INavierStokes/zoso/Bubble_RisingVap_3D -2d -auto -nxb=20 -nyb=20 -opt -maxblocks=300 -gridinterpolation=native +pm4dev -objdir=Bubble_RisingVap -site=pfe.nas.nasa.gov Bittree=0 ",400);
