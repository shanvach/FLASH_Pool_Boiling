subroutine ins_corrector_VD_MOD(uni,vni,wni,sigx,sigy,sigz,p,ix1,ix2,jy1,jy2,kz1,kz2, &
        dt,dx,dy,dz,alfa,rho1x,rho2x,rho1y,rho2y,rho1z,rho2z,phat,rho)
...
#include "Flash.h"
      ...
      REAL, INTENT(IN) :: dt,dx,dy,dz,alfa,rho
      REAL, DIMENSION(:,:,:), INTENT(IN) :: p,rho1x,rho2x,rho1y,rho2y,rho1z,rho2z,phat
...
end subroutine ins_corrector_VD_MOD
