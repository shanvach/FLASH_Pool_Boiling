...
#include "Flash.h"
   ...
   integer, dimension(1:46), parameter :: varnames = (/&
   & CON_ANGLE_VAR, DIVU_VAR, PTES_VAR, RTES_VAR, XI_VAR, &
     AAJUNK_VAR, ALPH_VAR, CURV_VAR, DELP_VAR, DFUN_VAR, &
     DUST_VAR, MDOT_VAR, MFLG_VAR, MGW1_VAR, MGW2_VAR, &
     MGW3_VAR, MGW4_VAR, MGW5_VAR, MGW6_VAR, MGW7_VAR, &
     NRMX_VAR, NRMY_VAR, NRMZ_VAR, OMGM_VAR, OMGX_VAR, &
     OMGY_VAR, OMGZ_VAR, PFUN_VAR, PREO_VAR, PRES_VAR, &
     RHSO_VAR, RHST_VAR, ROLD_VAR, SIGP_VAR, SMHV_VAR, &
     SMRH_VAR, TEMP_VAR, TMIC_VAR, TNLQ_VAR, TNVP_VAR, &
     TOLD_VAR, TVIS_VAR, VELX_VAR, VELY_VAR, VELZ_VAR, &
     VISC_VAR &
   &/)

   integer, dimension(1:46), parameter :: vartypes = (/&
