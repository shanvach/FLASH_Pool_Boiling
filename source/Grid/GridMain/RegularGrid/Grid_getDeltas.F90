!!****if* source/Grid/GridMain/UG/UGStretched/Grid_getDeltas
!!
!! NAME
!!  Grid_getDeltas
!!
...
#include "constants.h"
  ...
  print*,"Get Deltas : invalid operation for stretched grid "
  call Driver_abortFlash("Get Deltas : invalid operation for stretched grid ")  
