...
!===============================================================================
      ...
      subroutine ib_levelset_linearprojection(sn, s, sd, u, v, w)
        implicit none
        include 'mpif.h'
        integer i, j, k, npid, nop, nopx, nopy, nx, ny, nz, n
        integer nx1, nx2, ny1, ny2, nz1, nz2, dnx, dny, dnz
        double precision s, sd, sn, sX, sY, u, v, w, x, y, z
        ...
        dimension :: sd(nx,ny,nz), sn(nx,ny,nz), sX(nx,ny,nz), sY(nx,ny,nz)
