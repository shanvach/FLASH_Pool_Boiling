...
#include "constants.h"
        ...
        do j = jy1,jy2 
           do i = ix1,ix2 
              ...
              if (ur .gt. 0) then     !- kpd - u = (+) Downwind
              ...
              if (ul .gt. 0) then     !- kpd - u = (+) Downwind  
              ...
              if (vr .gt. 0) then     !- kpd - u = (+) Downwind
              ...
              if (vl .gt. 0) then     !- kpd - u = (+) Downwind
        ...
        end subroutine mph_IBadvectWENO3
