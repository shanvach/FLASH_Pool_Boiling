...
interface
        subroutine mph_KPDcurvature2DC(s,crv,rho1x,rho2x,rho1y,rho2y,pf,w,wcd,sigx,sigy,&
                   sigcx,sigcy,dx,dy,rho1,rho2,xit,crmx,crmn,ix1,ix2,jy1,jy2,blockID)
        implicit none
...
interface
        subroutine mph_KPDcurvature3DC(s,crv,rho1x,rho2x,rho1y,rho2y, &
                                       pf,w,wcd,sigx,sigy,sigcx,sigcy,dx,dy,          &
...
interface
     subroutine ins_updateConstCoef()
        implicit none

     end subroutine ins_updateConstCoef
end interface
