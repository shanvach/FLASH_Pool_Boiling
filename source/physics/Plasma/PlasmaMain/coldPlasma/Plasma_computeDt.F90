subroutine Plasma_computeDt(pls_mindt,pls_minloc)
  ...
  use Plasma_interface, ONLY : Plasma_computeDtLocal
...
#ifdef DEBUG_DRIVER
     print*,'going to call Plasma timestep'
#endif

     ! Plasma_computeDtLocal computed de blockID min_dt
     ! which if is .lt. dtLocal, is assigned to dtLocal
     call Plasma_computeDtLocal (blockID,         &
                         isize, jsize, ksize,  &
...
#ifdef DEBUG_DRIVER
     print*,'returned from Plasma timestep'
#endif
