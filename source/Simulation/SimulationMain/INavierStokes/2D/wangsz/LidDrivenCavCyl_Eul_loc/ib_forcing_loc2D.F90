...
!!
!!***
subroutine ib_forcing_loc2D(ibd,p,blockID,particleData,fx,fy)
...
#include "ImBound.h"
  ...
  do i = 1,NDIM
     ...
     if (force_fl(i)) then
        ...
        call ib_extrapEpoints_loc2D(part_Pos,sb,hl,del,ib_ielem(:,:,i),ib_phile(:,:,i),   &        
                              ib_FuL(i),blockID,FACE_IND(i),fx,fy)
...
end subroutine ib_forcing_loc2D
