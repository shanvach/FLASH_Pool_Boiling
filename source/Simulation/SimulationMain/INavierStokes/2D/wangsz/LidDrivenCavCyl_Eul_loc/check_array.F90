...
#include "constants.h"
      ...
      subroutine check_array(nxa,nya,nza,nxb,nyb,nzb,a,b,id,note)
      implicit none
      integer :: nxa, nya, nza
      integer :: nxb, nyb, nzb
      real :: a(nxa,nya,nza), b(nxb,nyb,nzb)
      integer :: id
      character(len=*) :: note
      ...
      write(10000+id,*) 'suma, sumb, id:', sum(a(GRID_ILO:GRID_IHI+1,GRID_JLO:GRID_JHI,GRID_KLO:GRID_KHI)), & 
                                           sum(b(GRID_ILO:GRID_IHI,GRID_JLO:GRID_JHI+1,GRID_KLO:GRID_KHI)), id
      write(10000+id,*) 'maxa, maxb, id:', maxval(a(GRID_ILO:GRID_IHI+1,GRID_JLO:GRID_JHI,GRID_KLO:GRID_KHI)), & 
                                           maxval(b(GRID_ILO:GRID_IHI,GRID_JLO:GRID_JHI+1,GRID_KLO:GRID_KHI)), id
      write(10000+id,*) 'mina, minb, id:', minval(a(GRID_ILO:GRID_IHI+1,GRID_JLO:GRID_JHI,GRID_KLO:GRID_KHI)), & 
                                           minval(b(GRID_ILO:GRID_IHI,GRID_JLO:GRID_JHI+1,GRID_KLO:GRID_KHI)), id
