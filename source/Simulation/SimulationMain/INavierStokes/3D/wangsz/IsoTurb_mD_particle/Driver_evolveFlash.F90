...
subroutine Driver_evolveFlash()
  ...
  use SolidMechanics_Data, only : sm_meshMe,sm_meshComm,sm_BodyInfo, sm_CL
...
#include "Flash.h"
 include "Flash_mpi.h"
  ...
  call sm_assemble_vel()

  if(dr_restart) then
     write(*,*) 'Critical length for particle', sm_CL
  ...
  do dr_nstep = dr_nBegin, dr_nend
     ...
     call Timers_start("Assemble_vel")
     call sm_assemble_vel()
     call Timers_stop("Assemble_vel")
