...
! Project external and marker Velocity on the plane:
  ...
  dpdxn = dpdx*nxp + dpdy*nyp + dpdz*nzp ! Notice: this is the hydrodynamic pressure in the case of isotropic turbulenc, in which the ins_grav* is set to be zero. The effect of gravity is taken into account by the buoyance. 
  !zL2   = zpres - dpdxn*h
  zL2   = zpres - dpdxn*h
