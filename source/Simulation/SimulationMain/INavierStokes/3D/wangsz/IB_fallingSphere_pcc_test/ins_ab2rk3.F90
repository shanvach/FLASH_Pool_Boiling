...
!!$#endif
  ...
  !write(*,*) 'Set the flow to Stokes'
  !call sm_setStokes(blockList, blockCount,1.0d0,timeEndAdv,-0.5*timeEndAdv**2)
  !call sm_setStokes(blockList, blockCount,1.0d0,1.0,0.0)
