...
!===== TEST TEST TEST TEST ===========
 ...
 call sm_copyToLocal(FORC_FACE_VAR,forceX,GRID_IHI_GC+1,GRID_JHI_GC,GRID_KHI_GC,NFACE_VARS,FACEX)
 call sm_copyToLocal(FORC_FACE_VAR,forceY,GRID_IHI_GC,GRID_JHI_GC+1,GRID_KHI_GC,NFACE_VARS,FACEY)
#if NDIM == MDIM
 call sm_copyToLocal(FORC_FACE_VAR,forceZ,GRID_IHI_GC,GRID_JHI_GC,GRID_KHI_GC+1,NFACE_VARS,FACEZ)
#endif
 ...
 do kk = 1, GRID_KHI_GC
   do jj = 1, GRID_JHI_GC
     do ii = 1, GRID_IHI_GC+1
       if(abs(forceX(ii,jj,kk))>1.0d-12) then
       write(3000000+gr_meshMe,*) forceX(ii,jj,kk), ii, jj, kk
       endif
     enddo
   enddo
 enddo
 ...
 do kk = 1, GRID_KHI_GC
   do jj = 1, GRID_JHI_GC+1
     do ii = 1, GRID_IHI_GC
       if(abs(forceY(ii,jj,kk))>1.0d-12) then
       write(4000000+gr_meshMe,*) forceY(ii,jj,kk), ii, jj, kk
       endif
     enddo
   enddo
 enddo

 do kk = 1, GRID_KHI_GC+1
   do jj = 1, GRID_JHI_GC
     do ii = 1, GRID_IHI_GC
       if(abs(forceZ(ii,jj,kk))>1.0d-12) then
       write(5000000+gr_meshMe,*) forceZ(ii,jj,kk), ii, jj, kk
       endif
     enddo
   enddo
 enddo
...
!===== TEST TEST TEST TEST ===========
 ...
 do kk = 1, GRID_KHI_GC
   do jj = 1, GRID_JHI_GC
     do ii = 1, GRID_IHI_GC+1
       if(abs(forceX(ii,jj,kk)) > 1.0d-12) then
       write(3100000+gr_meshMe,*) forceX(ii,jj,kk), ii, jj, kk
       endif
     enddo
   enddo
 enddo
 ...
 do kk = 1, GRID_KHI_GC
   do jj = 1, GRID_JHI_GC+1
     do ii = 1, GRID_IHI_GC
       if(abs(forceY(ii,jj,kk)) > 1.0d-12) then
       write(4100000+gr_meshMe,*) forceY(ii,jj,kk), ii, jj, kk
       endif
     enddo
   enddo
 enddo
 ...
 do kk = 1, GRID_KHI_GC+1
   do jj = 1, GRID_JHI_GC
     do ii = 1, GRID_IHI_GC
       if(abs(forceZ(ii,jj,kk)) > 1.0d-12) then
       write(5100000+gr_meshMe,*) forceZ(ii,jj,kk), ii, jj, kk
       endif
     enddo
   enddo
 enddo
 ...
 do kk = 1, GRID_KHI_GC
   do jj = 1, GRID_JHI_GC
     do ii = 1, GRID_IHI_GC+1
       if(abs(tmpX(ii,jj,kk)) > 1.0d-12) then
         write(3200000+gr_meshMe,*) tmpX(ii,jj,kk), ii, jj, kk
       endif
     enddo
   enddo
 enddo
 ...
 do kk = 1, GRID_KHI_GC
   do jj = 1, GRID_JHI_GC+1
     do ii = 1, GRID_IHI_GC
       if(abs(tmpY(ii,jj,kk)) > 1.0d-12) then
         write(4200000+gr_meshMe,*) tmpY(ii,jj,kk), ii, jj, kk
       endif
     enddo
   enddo
 enddo
 ...
 do kk = 1, GRID_KHI_GC+1
   do jj = 1, GRID_JHI_GC
     do ii = 1, GRID_IHI_GC
       if(abs(tmpZ(ii,jj,kk)) > 1.0d-12) then
         write(5200000+gr_meshMe,*) tmpZ(ii,jj,kk), ii, jj, kk
       endif
     enddo
   enddo
 enddo
