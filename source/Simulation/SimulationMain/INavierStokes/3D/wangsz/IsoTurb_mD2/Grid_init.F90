...
#include "constants.h"
  ...
  write(10000000+gr_meshMe,*) 'gr_globalComm', gr_globalComm
  write(10000000+gr_meshMe,*) 'gr_meshComm', gr_meshComm
  write(10000000+gr_meshMe,*) 'gr_meshAcrossComm', gr_meshAcrossComm
  write(10000000+gr_meshMe,*) 'gr_axisComm', gr_axisComm
...
!!  end do
  ...
  gr_bufSize = NXB*NYB*NPROP_VARS*NGUARD*8*2
  allocate(gr_sendBuf(gr_bufSize))
