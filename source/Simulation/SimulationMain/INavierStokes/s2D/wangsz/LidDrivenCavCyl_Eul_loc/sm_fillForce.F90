...
#include "Flash.h"
  ...
  real, dimension(GRID_IHI_GC,GRID_JHI_GC,GRID_KHI_GC+1), intent(in) :: fZ
  ...
  real, dimension(GRID_IHI_GC,GRID_JHI_GC,GRID_KHI_GC+1), intent(out) :: tmpZ
