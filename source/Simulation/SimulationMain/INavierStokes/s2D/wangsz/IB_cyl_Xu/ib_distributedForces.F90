...
subroutine ib_distributedForces(blockID, particleData, vortx, vorty, vortz)
  ...
  real :: fvxen2_c2, fvyen2_c2, fvxw_c22, fvyw_c22, wz_2n_e2_c2, wz_2n_w_c22
  real :: pppxn, pres_c, ss
  real :: pppxn2, pres_c2
...
!########################################################
 ...
 !########################################################
  ...
  fvxen2_c2 =((nxp*nxp*ddudxdx2+nxp*nyp*ddudxdy2*2.+nyp*nyp*ddudydy2)*tx + &
            & (nxp*nxp*ddvdxdx2+nxp*nyp*ddvdxdy2*2.+nyp*nyp*ddvdydy2)*ty - &
            & (nxp*nxp*ddudxdx+nxp*nyp*ddudxdy*2.+nyp*nyp*ddudydy)*tx    - &
            & (nxp*nxp*ddvdxdx+nxp*nyp*ddvdxdy*2.+nyp*nyp*ddvdydy)*ty)/(enh2-enh1)*tx*nu*enh2*enh2*0.5
  
  fvyen2_c2 =((nxp*nxp*ddudxdx2+nxp*nyp*ddudxdy2*2.+nyp*nyp*ddudydy2)*tx + &
            & (nxp*nxp*ddvdxdx2+nxp*nyp*ddvdxdy2*2.+nyp*nyp*ddvdydy2)*ty - &
            & (nxp*nxp*ddudxdx+nxp*nyp*ddudxdy*2.+nyp*nyp*ddudydy)*tx    - &
            & (nxp*nxp*ddvdxdx+nxp*nyp*ddvdxdy*2.+nyp*nyp*ddvdydy)*ty)/(enh2-enh1)*ty*nu*enh2*enh2*0.5
  ...
  fvxw_c22 = ss*ss/(1-ss)/(1.-ss)*fvxen1 + (1.-2.*ss)/(1.-ss)/(1.-ss)*fvxen2 - 1.0/(ss-1)*fvxen2_c 
  fvyw_c22 = ss*ss/(1-ss)/(1.-ss)*fvyen1 + (1.-2.*ss)/(1.-ss)/(1.-ss)*fvyen2 - 1.0/(ss-1)*fvyen2_c 
 
  !fvxw_c22 = fvxen2 + fvxen2_c + fvxen2_c2
  !fvyw_c22 = fvyen2 + fvyen2_c + fvyen2_c2

  wz_2n_e2_c = fvyen2_c/nu*nxp - fvxen2_c/nu*nyp
  wz_2n_w_c2  = wz_2n_e2 + wz_2n_e2_c

  wz_2n_e2_c2  = fvyen2_c2/nu*nxp - fvxen2_c2/nu*nyp
  wz_2n_w_c22  = wz_2n_e2 + wz_2n_e2_c + wz_2n_e2_c2
  !wz_2n_w_c22 = ss*ss/(1-ss)/(1-ss)*wz_2n_e1 +  &
  !            & (1.-2.*ss)/(1.-ss)/(1.-ss)*wz_2n_e2 + &
  !            & 1.0/(1.0-ss)*wz_2n_e2_c

  pppxn = -(uen2*dudx2*nxp+uen2*dvdx2*nyp+ven2*dudy2*nxp+ven2*dvdy2*nyp)
  pppxn2 = dpdx2*nxp + dpdy2*nyp

  pres_c = zpres2 - pppxn*enh2
  ...
  write(9200+gr_meshMe, '(30f20.12)') particleData(GLOB_PART_PROP), pres_c2, zL2, &
                       zpres2
  ...
  write(9400+gr_meshMe, '(30f20.8)') particleData(GLOB_PART_PROP), zL, zL2, &
                       zpres, zpres2, pres_c, pres_c2, -pppxn*enh2, -pppxn2*enh2

  write(9500+gr_meshMe, '(30f20.8)') particleData(GLOB_PART_PROP), zL, zL2, &
                       zpres, zpres2, dpdx, dpdy, dpdx2, dpdy2, &
                       ppppxpx, ppppxpy, ppppypy, &
  ...
  write(9800+gr_meshMe, '(30f20.8)') particleData(GLOB_PART_PROP), zL, zL2,  &
                       ...
                       pres_c, zpres2, -pppxn, pres_c2, -pppxn2, wz_2n_w_c22, &
                       wz_2n_e2_c2, wz_2n_e1, wz_2n_e1_c

  write(9900+gr_meshMe, '(30f20.8)') particleData(GLOB_PART_PROP), &
                       wz_2n_w_c2, wz_2n_e2, wz_2n_e2_c, &
                       wz_2n_w_c,  wz_2n_e1, wz_2n_e1_c, &
                       wz_2n_e2_ppc, wz_2n_e2_ppc3
...
#endif
#ifdef TWO_NORMAL_POINTS_EUL
  particleData(FXVI_PART_PROP) = fvxw
  particleData(FYVI_PART_PROP) = fvyw 
#endif
