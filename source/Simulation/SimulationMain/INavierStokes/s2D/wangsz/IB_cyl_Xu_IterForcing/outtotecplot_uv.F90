...
!  Shizhao Wang output pressure gradient

  ! write solution data to PPPX.XXXX.XX
  write(filename,'("./IOData/PPPX.",i4.4,".",i2.2,".plt")') &
        count, mype
  ...
  do lb = 1,blockcount
     ...
     do j=NGUARD+1,nyc-1              
        do i=NGUARD+1,nxc-1
            ...
            presvar(i,j) = solnData(PPPX_VAR,i,j,1)
  ...
  ! write solution data to PPPY.XXXX.XX
  write(filename,'("./IOData/PPPY.",i4.4,".",i2.2,".plt")') &
        count, mype
  ...
  do lb = 1,blockcount
     ...
     do j=NGUARD+1,nyc-1              
        do i=NGUARD+1,nxc-1
            ...
            presvar(i,j) = solnData(PPPY_VAR,i,j,1)
...
! write solution data to UVELGDX.XXXX.XX
  write(filename,'("./IOData/PUPX.",i4.4,".",i2.2,".plt")') &
        count, mype
     ...
     do j=NGUARD,nyc              
        do i=NGUARD+1,nxc
           ...
           if (j .eq. NGUARD) then
              ...
              facevarxx(i,j) =  0.5*(facexData(PPX_FACE_VAR,i,j,1)+    &
                                     facexData(PPX_FACE_VAR,i,j+1,1)) 
           ...
           elseif (j .eq. nyc) then
              ...
              facevarxx(i,j) = facexData(PPX_FACE_VAR,i,j,1) 
...
!  close(333)
  ...
  ! write solution data to PVVELPX.XXXX.XX
  write(filename,'("./IOData/PVPX.",i4.4,".",i2.2,".plt")') &
        count, mype
     ...
     do j=NGUARD+1,nyc              
        ...
        do i=NGUARD,nxc
           ...
           if (i .eq. NGUARD) then
              ...
              facevaryy(i,j) =  0.5*(faceyData(PPX_FACE_VAR,i,j,1)+    &
                                     faceyData(PPX_FACE_VAR,i+1,j,1))
           ...
           elseif (i .eq. nxc) then
              ...
              facevaryy(i,j) = faceyData(PPX_FACE_VAR,i,j,1)
...
! write solution data to PUVELPY.XXXX.XX
  write(filename,'("./IOData/PUPY.",i4.4,".",i2.2,".plt")') &
        count, mype
     ...
     do j=NGUARD,nyc              
        do i=NGUARD+1,nxc
           ...
           if (j .eq. NGUARD) then
              ...
              facevarxx(i,j) =  0.5*(facexData(PPY_FACE_VAR,i,j,1)+    &
                                     facexData(PPY_FACE_VAR,i,j+1,1)) 
           ...
           elseif (j .eq. nyc) then
              ...
              facevarxx(i,j) = facexData(PPY_FACE_VAR,i,j,1) 
...
!  close(333)
  ...
  ! write solution data to PVVELPY.XXXX.XX
  write(filename,'("./IOData/PVPY.",i4.4,".",i2.2,".plt")') &
        count, mype
     ...
     do j=NGUARD+1,nyc              
        ...
        do i=NGUARD,nxc
           ...
           if (i .eq. NGUARD) then
              ...
              facevaryy(i,j) =  0.5*(faceyData(PPY_FACE_VAR,i,j,1)+    &
                                     faceyData(PPY_FACE_VAR,i+1,j,1))
           ...
           elseif (i .eq. nxc) then
              ...
              facevaryy(i,j) = faceyData(PPY_FACE_VAR,i,j,1)
