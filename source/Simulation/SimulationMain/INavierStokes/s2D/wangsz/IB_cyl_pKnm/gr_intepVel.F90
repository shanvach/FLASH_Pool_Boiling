     ...
     if (bodyInfo % myPE == bodyInfo % bodyMaster) then
        ...
        do i = 1, localCount
           ...
           if (int(particles2(PROC_PART_PROP,i)) == bodyInfo % bodyMaster) then
              ...
              bodyInfo % particles(UUPD_PART_PROP,i) = particleData(UUPD_PART_PROP)   
              bodyInfo % particles(VUPD_PART_PROP,i) = particleData(VUPD_PART_PROP)   
              bodyInfo % particles(WUPD_PART_PROP,i) = particleData(WUPD_PART_PROP)   
           ...
           do p = 1, recvCount
              ...
              bodyInfo % particles(UUPD_PART_PROP,p) = particleData(UUPD_PART_PROP)   
              bodyInfo % particles(VUPD_PART_PROP,p) = particleData(VUPD_PART_PROP)   
              bodyInfo % particles(WUPD_PART_PROP,p) = particleData(WUPD_PART_PROP)   
           enddo
