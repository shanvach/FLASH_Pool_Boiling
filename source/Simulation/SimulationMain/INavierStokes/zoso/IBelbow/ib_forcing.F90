...
subroutine ib_forcing(ibd,p,blockID,particleData)
  ...
  use SolidMechanics_data, only : sm_structure, sm_bodyInfo, sm_MeshMe 
...
#include "SolidMechanics.h"
  ...
  real :: part_Nml(MDIM), part_temp, part_dfun, outloc
  ...
  integer :: idx_out,idx_out2,nel,wsout
  ...
  outloc = particleData(OUTLOC_PART_PROP);
