...
subroutine ib_distributedForces(blockID, particleData, vortx, vorty, vortz)
  ...
  use Grid_interface, ONLY : Grid_getBlkPtr, Grid_releaseBlkPtr,      &
                             ...
                             Grid_getBlkPhysicalSize,Grid_getCellMetrics
  ...
  del(IAXIS) = 1.0/dx_t(1,CENTER,blockID)
  del(JAXIS) = 1.0/dy_t(1,CENTER,blockID)
#if NDIM == MDIM
  del(KAXIS) = 1.0/dz_t(1,CENTER,blockID)
#endif
...
#ifdef TEST_COMPARE
  write(*,'(10f20.12)') particleData(GLOB_PART_PROP), zL2, zL, zpres 
  write(*,'(30f20.12)') particleData(GLOB_PART_PROP), zv(1), w_l(1), w_c(1), w_cc(1) 
