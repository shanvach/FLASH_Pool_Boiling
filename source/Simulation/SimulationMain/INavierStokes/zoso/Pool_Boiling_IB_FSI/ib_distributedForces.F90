...
!########################################################
  ...
  do presflag = CONSTANT_ONE,CONSTANT_ONE
...
!########################################################
  ...
  fvxw_c3 = fvxen2 + fvxen2_c - fvxen2_ppc3
  fvyw_c3 = fvyen2 + fvyen2_c - fvyen2_ppc3
...
#endif
#ifdef TWO_NORMAL_POINTS_EUL
  particleData(FXVI_PART_PROP) = fvxw_c3
  particleData(FYVI_PART_PROP) = fvyw_c3 
