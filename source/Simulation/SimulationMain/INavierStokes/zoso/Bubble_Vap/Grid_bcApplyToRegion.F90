     ...
     if(mask(ivar)) then
        ...
        if(face==LOW) then
           ...
           case(NOSLIP_INS)
              ...
              case (PRES_VAR,DELP_VAR,TVIS_VAR,PFUN_VAR,VISC_VAR,DFUN_VAR,CURV_VAR,THCO_VAR,CPRS_VAR,NRMX_VAR,NRMY_VAR,TNLQ_VAR,TNVP_VAR,MDOT_VAR,SMHV_VAR,SMRH_VAR,TESTVAL_VAR) ! Shizhao
              k = 2*guard+1
              do i = 1,guard
                 regionData(i,1:je,1:ke,ivar)= regionData(k-i,1:je,1:ke,ivar)
              end do        
...
!****************************************************************************
           ...
           case(SLIP_INS)
              ...
              select case(ivar)
              !case (PRES_VAR,DELP_VAR,TVIS_VAR)
              case (PRES_VAR,DELP_VAR,TVIS_VAR,DFUN_VAR,PFUN_VAR,CURV_VAR,VISC_VAR,THCO_VAR,CPRS_VAR,NRMX_VAR,NRMY_VAR,TNLQ_VAR,TNVP_VAR,MDOT_VAR,SMHV_VAR,SMRH_VAR,TESTVAL_VAR)    !1to6, 2to5, 3to4
                    !--------------------------------------------------------------!
           ...
           case(INFLOW_INS)
              ...
              select case(ivar)
              !case (PRES_VAR,DELP_VAR,TVIS_VAR)
              case (PRES_VAR,DELP_VAR,TVIS_VAR,PFUN_VAR,CURV_VAR,VISC_VAR,THCO_VAR,CPRS_VAR,NRMX_VAR,NRMY_VAR,TNLQ_VAR,TNVP_VAR,MDOT_VAR,SMHV_VAR,SMRH_VAR,TESTVAL_VAR) !1to6, 2to5, 3to4
...
!!              call Driver_abortFlash("unsupported boundary condition on Lower Face")
           ...
           case(NEUMANN_INS)  ! Neumann BC
              ...
              select case(ivar)
              case (PTES_VAR,PRES_VAR,DELP_VAR)
              k = 2*guard+1
              do i = 1,guard
                 regionData(k-i,1:je,1:ke,ivar)= -regionData(i,1:je,1:ke,ivar)
              end do           
...
!****************************************************************************
           ...
           case(SLIP_INS)
              ...
              select case(ivar)
              !case (PRES_VAR,DELP_VAR,TVIS_VAR)
              case (PRES_VAR,DELP_VAR,TVIS_VAR,DFUN_VAR,PFUN_VAR,CURV_VAR,VISC_VAR,THCO_VAR,CPRS_VAR,NRMX_VAR,NRMY_VAR,TNLQ_VAR,TNVP_VAR,MDOT_VAR,SMHV_VAR,SMRH_VAR,TESTVAL_VAR)
