       ...
       do k=blkLimits(LOW,KAXIS),blkLimits(HIGH,KAXIS)
        ...
        do j=blkLimits(LOW,JAXIS),blkLimits(HIGH,JAXIS)
         do i=blkLimits(LOW,IAXIS),blkLimits(HIGH,IAXIS)
           ...
           thxp = abs(solnData(LMDO_VAR,i,j,k))/(abs(solnData(LMDO_VAR,i,j,k))+abs(solnData(LMDO_VAR,i+1,j,k)))
           thxm = abs(solnData(LMDO_VAR,i,j,k))/(abs(solnData(LMDO_VAR,i,j,k))+abs(solnData(LMDO_VAR,i-1,j,k)))
           thyp = abs(solnData(LMDO_VAR,i,j,k))/(abs(solnData(LMDO_VAR,i,j,k))+abs(solnData(LMDO_VAR,i,j+1,k)))
           thym = abs(solnData(LMDO_VAR,i,j,k))/(abs(solnData(LMDO_VAR,i,j,k))+abs(solnData(LMDO_VAR,i,j-1,k)))
 
#if NDIM == 3
           thzp = abs(solnData(LMDO_VAR,i,j,k))/(abs(solnData(LMDO_VAR,i,j,k))+abs(solnData(LMDO_VAR,i,j,k+1)))
           thzm = abs(solnData(LMDO_VAR,i,j,k))/(abs(solnData(LMDO_VAR,i,j,k))+abs(solnData(LMDO_VAR,i,j,k-1)))
#endif

           !------Dirichlet - Method 1----------------------------------------!
           !------------------------------------------------------------------!

           if(solnData(LMDO_VAR,i,j,k)*solnData(LMDO_VAR,i+1,j,k) .le. 0.d0) &
           ...
           if(solnData(LMDO_VAR,i,j,k)*solnData(LMDO_VAR,i,j+1,k) .le. 0.d0) &
...
#if NDIM == 3
           if(solnData(LMDO_VAR,i,j,k)*solnData(LMDO_VAR,i,j,k+1) .le. 0.d0) &
           ...
           if(solnData(LMDO_VAR,i,j,k)*solnData(LMDO_VAR,i+1,j,k) .le. 0.0 .or. &
              solnData(LMDO_VAR,i,j,k)*solnData(LMDO_VAR,i-1,j,k) .le. 0.0 .or. &
              solnData(LMDO_VAR,i,j,k)*solnData(LMDO_VAR,i,j+1,k) .le. 0.0 .or. &
              solnData(LMDO_VAR,i,j,k)*solnData(LMDO_VAR,i,j-1,k) .le. 0.0) then
