...
#include "SolidMechanics.h"
  ...
  use Heat_AD_interface, only : Heat_Solve ! Diffusion Module : Akash
...
!#endif
  ...
  real, dimension(GRID_IHI_GC,GRID_JHI_GC,GRID_KHI_GC) :: newT
...
!___________ Heat Conv Diff Procedure - Akash __________________!
!_______________________________________________________________!
  ...
  do lb = 1,blockCount
     ...
     newT = solnData(TEMP_VAR,:,:,:)
     
     call Heat_Solve(solnData(TEMP_VAR,:,:,:), newT,&
...
!_______________________________________________________________!
!________ Heat Conv Diff Procedure End - Akash _________________!
!_______________________________________________________________!
