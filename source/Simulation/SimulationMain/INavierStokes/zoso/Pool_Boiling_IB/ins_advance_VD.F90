...
#include "Flash.h"
      ...
      divv(ix1:ix2,jy1:jy2,kz1:kz2) =           &
         ( uni(ix1+1:ix2+1,jy1:jy2,kz1:kz2) -   &
           uni(ix1:ix2,jy1:jy2,kz1:kz2))/dx + (aixr - aixl)/dx +  &
         ( vni(ix1:ix2,jy1+1:jy2+1,kz1:kz2) -   &
           vni(ix1:ix2,jy1:jy2,kz1:kz2))/dy + (aiyr - aiyl)/dy

#if NDIM == 3
      divv(ix1:ix2,jy1:jy2,kz1:kz2) =           &
           divv(ix1:ix2,jy1:jy2,kz1:kz2)    +  &
         ( wni(ix1:ix2,jy1:jy2,kz1+1:kz2+1) -   &
           wni(ix1:ix2,jy1:jy2,kz1:kz2))/dz + (aizr - aizl)/dz
#endif
...
#include "Flash.h"
      ...
      REAL, DIMENSION(:,:,:), INTENT(IN OUT) :: uni,vni,wni,sigx,sigy,sigz,poldx,&
                                                poldy,poldz
