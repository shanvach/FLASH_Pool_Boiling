...
!          solnData(DFUN_VAR,i,j,k) = ycell - A0/(cosh(sqrt(3.0*A0)*xcell/2)**2)
          ...
          ! Circle
           ...
           solnData(DFUN_VAR,i,j,k) = (10.88/128.)*(4+cos(2*acos(-1.0)*(sqrt(xcell**2+zcell**2))/10.88))-ycell
           !solnData(DFUN_VAR,i,j,k) = (10.88/128. )*(4+cos(2*acos(-1.0)*(xcell)/10.88)) - ycell 
