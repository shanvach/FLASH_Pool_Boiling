...
subroutine Simulation_initBlock(blockId)
  ...
  use Simulation_data, ONLY : sim_xMin, sim_xMax, &
                              ...
                              sim_xmin1, sim_xmax1, sim_xmin2, sim_xmax2,  &
                              sim_ymin1, sim_ymax1, sim_ymin2, sim_ymax2, sim_vel, &
                              sim_xjet, sim_vel_flg, sim_pres_flg, sim_dfun_top, &
                              sim_xjet_top, sim_vel_flg_top, sim_pres_flg_top,sim_vel_top
...
#include "Flash.h"
  ...
  real    :: xmin_fs, xmax_fs, ymin_fs, ymax_fs
  ...
  do k=1,blkLimitsGC(HIGH,KAXIS)
     do j=1,blkLimitsGC(HIGH,JAXIS)
        do i=1,blkLimitsGC(HIGH,IAXIS)
           ...
           solnData(DFUN_VAR,i,j,k) = -min(xcell-sim_xmin1, sim_xmax1-xcell, &
                                           ycell-sim_ymin1, sim_ymax1-ycell)
