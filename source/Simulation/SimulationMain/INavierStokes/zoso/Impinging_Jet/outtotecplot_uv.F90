     ...
     do j=NGUARD,nyc              
        do i=NGUARD+1,nxc
           ...
           if (j .eq. NGUARD) then
              ...
              facevarxx(i,j) =  0.5*(facexData(MAGF_FACE_VAR,i,j,1)+    &
                                     facexData(MAGF_FACE_VAR,i,j+1,1)) 
           ...
           elseif (j .eq. nyc) then
              ...
              facevarxx(i,j) = facexData(MAGF_FACE_VAR,i,j,1) 
     ...
     do j=NGUARD+1,nyc              
        ...
        do i=NGUARD,nxc
           ...
           if (i .eq. NGUARD) then
              ...
              facevaryy(i,j) =  0.5*(faceyData(MAGF_FACE_VAR,i,j,1)+    &
                                     faceyData(MAGF_FACE_VAR,i+1,j,1))
           ...
           elseif (i .eq. nxc) then
              ...
              facevaryy(i,j) = faceyData(MAGF_FACE_VAR,i,j,1)
