...
!-----------------------------------------------------------------------------------------
  ...
  call outtotecplot_jet(dr_globalMe,dr_simtime,dr_dt,dr_nstep,count, &
                    0.0,blockList,blockCount,firstfileflag)
...
!     endif
     !--------------------------------------------------------------------
     if (pls_cflflg .eq. 1) then ! Constant cfl       
