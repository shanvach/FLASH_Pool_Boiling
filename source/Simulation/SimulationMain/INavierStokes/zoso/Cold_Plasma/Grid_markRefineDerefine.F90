...
! end do
  ...
  specs(1) = real(DELE_VAR)
  specs(2) =  5.0e17  ! lower boundary of the refinement
  specs(3) =  1.0e18  ! upper boundary of the refinement
  !specs(2) = -5.0d0
  !specs(3) =  0.0d0

  !! index of the threshold var
!  specs(1) = real(TEMP_VAR)
!  specs(2) =  0.10d0  ! lower boundary of the refinement
!  specs(3) =  1.00d0  ! upper boundary of the refinement
...
!  specs(4) =  0.0  !sim_yMin + 4./4.*(sim_yMax - sim_yMin) -.005
  specs(3) =  0.0  !sim_yMin + 2./4.*(sim_yMax - sim_yMin) +.005
