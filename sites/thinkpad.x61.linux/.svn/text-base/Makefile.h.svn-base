# FLASH makefile definitions for i386 Linux (GNU compilers)
#
#----------------------------------------------------------------------------
...
LIB_MPI   = -L${MPI_PATH}/lib/openmpi/lib  -lmpi_f90 -lmpi_cxx -lmpi  
...
TEC_PLOT=YES
#ifeq ($(TEC_PLOT), YES)
CONFIG_LIB = -I${setup_dir}/../source/Simulation/SimulationMain/INavierStokes -L${setup_dir}/../lib/tecio_x61 -ltecio
#endif
