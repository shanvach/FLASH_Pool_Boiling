#-------------------------------------------------------------------
# FLASH makefile definitions for BG/Q (VEAS)
# Running make will use the raw compilers.
# We can use the compilers directly using USE_BG_COMPILERS=True

# NOTE: The veas home directories are mounted as read-only.
# We must launch the flash4 binary from /veas-fs0/$USER
#-------------------------------------------------------------------
...
HDF5_PATH = /gpfs/vesta_scratch/projects/TurbNuclComb_esp/cdaley/vesta/software/V1R2M0/hdf5/1.8.10/xl/ibm-compilers-nov2012
NCMPI_PATH =
ZLIB_PATH =
PNG_PATH =
