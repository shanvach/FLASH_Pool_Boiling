...
MPI_PATH = /homes/jqiao/mpich-install
HDF4_PATH  =
HDF5_PATH  = /homes/jqiao/hdf5-install
...
BLAS_PATH    = /homes/jqiao/libraries/BLAS-3.8.0/blas_LINUX.a
#/local
#HYPRE_PATH   = /usr/local/hypre_2.9
#HYPRE_PATH    = /usr/local/hypre
HYPRE_PATH    = /homes/jqiao/libraries/hypre
